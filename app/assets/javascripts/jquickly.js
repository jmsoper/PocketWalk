(function(root) {
  ...
  root.$q.ajax = function (options) {
    var defaults = {
      success: root.$q.success,
      error: root.$q.error,
    ...
    options = root.$q.extend(defaults, options);
    root.$q.loadXMLDoc(options);
  };

  root.$q.error = function () {
    return "error!";
  };

  root.$q.success = function () {
    return "success!";
  };

  root.$q.loadXMLDoc = function (options) {
    var xmlhttp;
