  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Tour" do
        expect {
          post :create, params: {tour: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved tour as @tour" do
        post :create, params: {tour: invalid_attributes}, session: valid_session
        expect(assigns(:tour)).to be_a_new(Tour)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested tour" do
        tour = Tour.create! valid_attributes
        put :update, params: {id: tour.to_param, tour: new_attributes}, session: valid_session
        tour.reload
      ...
      it "assigns the requested tour as @tour" do
        tour = Tour.create! valid_attributes
        put :update, params: {id: tour.to_param, tour: valid_attributes}, session: valid_session
        expect(assigns(:tour)).to eq(tour)
      end
    ...
    context "with invalid params" do
      it "assigns the tour as @tour" do
        tour = Tour.create! valid_attributes
        put :update, params: {id: tour.to_param, tour: invalid_attributes}, session: valid_session
        expect(assigns(:tour)).to eq(tour)
      end
